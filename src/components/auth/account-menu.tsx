...
import { BadgeCheck, Bell, BriefcaseBusiness, ClipboardList, LogOut, ShieldCheck, UserRound, UsersRound, WalletCards } from "lucide-react";
    ...
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-13 z-50 w-64 rounded-2xl border border-stone-200 bg-white p-2 shadow-xl dark:border-stone-700 dark:bg-stone-900">
          ...
          <Link href="/notifications" onClick={() => setOpen(false)} className="flex min-h-11 items-center gap-2 rounded-xl px-3 text-sm font-semibold hover:bg-stone-100 dark:hover:bg-stone-800"><Bell className="size-4" /> Уведомления</Link>
